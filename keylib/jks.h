...
/** @fn void JKSFree(JKSEntry* entry)
...
/** @fn const char* JKSEntryCertType(const JKSEntry* entry)
...
/** @fn int readKey6(FILE* fp, const char* password, size_t passSize, JKS** keys)
...
/** @fn int readKey6_bio(BIO* bio, const char* password, size_t passSize, JKS** keys)
